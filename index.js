...
let blueNoise512 = new THREE.TextureLoader().load(
  "assets/blue_noise_rgb_512.png",
  (texture) => {
    ...
    ground = new THREE.Mesh(
      ...
      SSRMaterial({
        ...
        map: new THREE.TextureLoader().load(
          "assets/marble_01_diff_1k_3.jpg",
          (texture) => {
